...
%añadimos el valor de épsilon para el suavizado
laplace = 0.0001;

%aplicamos la semilla de randomizado y barajamos
[nrows,ncols]=size(data);
rand("seed",23);
perm=randperm(nrows);
pdata=data(perm,:);

%separamos los datos de entrenamiento con una relación 90/10
trper=0.9;
